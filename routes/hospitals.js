...
// Public — used by StaffLogin hospital picker
...
router.get('/stats', verifyToken, isHospitalAdmin, async (req, res) => {
  try {
    const hospitalId = req.user.hospital_id;

    // ── Reliable today range ─────────────────────────────────────────────────
...
// Returns the current hospital's profile
router.get('/me', verifyToken, isHospitalAdmin, async (req, res) => {
  try {
...
router.put('/profile', verifyToken, isHospitalAdmin, async (req, res) => {
  try {

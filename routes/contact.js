...
// ─── POST /api/contact ───────────────────────────────────────────────────────
// Saves submission to DB and sends notification email to admin
router.post('/', async (req, res) => {
    try {
        ...
        // ── Send email (non-blocking — don't fail the request if mail fails) ─────
...
// ─── GET /api/contact ─────────────────────────────────────────────────────────
// Admin-only: list all contact submissions (add your auth middleware when ready)

...
// ─────────────────────────────────────────────────────────────────────────────
// Single transporter — reuses your existing GMAIL_USER / GMAIL_APP_PASSWORD
...
//   1. Admin notification  → GMAIL_USER (or GMAIL_ADMIN if set)
//   2. Auto-reply          → the person who submitted
// ─────────────────────────────────────────────────────────────────────────────
async function sendContactEmail(contact) {
  const FROM  = `"HMSCare" <${process.env.GMAIL_USER}>`;
  // GMAIL_ADMIN lets you route notifications to a different address than the sender
  // e.g. GMAIL_ADMIN=support@yourhospital.com — falls back to GMAIL_USER if not set
...
module.exports = { sendStaffCredentials, sendPatientCredentials, sendContactEmail };
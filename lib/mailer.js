      ...
      <body style="margin:0;padding:0;background:#f0f4fb;font-family:'Segoe UI',sans-serif;">
        <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <div style="padding:32px 36px;">
            ...
            <p style="margin:0 0 8px;font-size:15px;font-weight:700;color:#111827;">Hello, ${adminName} 👋</p>
            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.7;">
              <strong>${hospitalName}</strong> has been reviewed and
          ...
          <div style="padding:20px 36px;border-top:1px solid #f3f4f6;background:#fafafa;">
            <p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;">
              ...
              <a href="mailto:support@apexcare.com" style="color:#FF5A1F;text-decoration:none;">support@apexcare.com</a><br>
              © ApexCare Platform · Powered by Anchorsoft Innovation Limited
            </p>
          </div>
        </div>
    ...
    html: `
      ...
      <body style="margin:0;padding:0;background:#f0f4fb;font-family:'Segoe UI',sans-serif;">
        <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <div style="padding:32px 36px;">
            <div style="text-align:center;margin-bottom:28px;">
              <div style="display:inline-flex;align-items:center;justify-content:center;width:72px;height:72px;background:#fff1f2;border-radius:50%;margin-bottom:16px;">
                <span style="font-size:36px;">⛔</span>
              </div>
              <h2 style="margin:0;font-size:22px;font-weight:800;color:#0A1A3F;">Account Suspended</h2>
            </div>
            <p style="margin:0 0 8px;font-size:15px;font-weight:700;color:#111827;">Hello, ${adminName} 👋</p>
            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.7;">
              Your hospital <strong>${hospitalName}</strong> has been <strong style="color:#be123c;">suspended</strong>
              on the ApexCare platform. Access to your dashboard has been temporarily disabled.
            </p>
            <div style="background:#fff1f2;border:1px solid #fecdd3;border-radius:12px;padding:20px 24px;margin-bottom:24px;">
              <p style="margin:0 0 10px;font-size:13px;font-weight:700;color:#9f1239;">What this means:</p>
              <ul style="margin:0;padding:0 0 0 18px;font-size:13px;color:#374151;line-height:2.2;">
            ...
            <div style="background:#f8faff;border:1px solid #e0e7ff;border-radius:10px;padding:14px 18px;">
              <p style="margin:0;font-size:13px;color:#374151;">
                📧 To appeal or resolve this, contact us at
                <a href="mailto:support@apexcare.com" style="color:#FF5A1F;text-decoration:none;">support@apexcare.com</a>
              </p>
            </div>
          </div>
...
// ─── Hospital rejection / deletion email ──────────────────────────────────────
        ...
        <div style="max-width:520px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
          ...
          <div style="padding:32px 36px;">
            <div style="text-align:center;margin-bottom:28px;">
              ...
              <h2 style="margin:0;font-size:22px;font-weight:800;color:#0A1A3F;">Registration Not Approved</h2>
            </div>
            <p style="margin:0 0 8px;font-size:15px;font-weight:700;color:#111827;">Hello, ${adminName} 👋</p>
            <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.7;">
              After reviewing your registration for <strong>${hospitalName}</strong>, we are unable to approve
              your application at this time. Your registration has been removed from our platform.
            </p>
            ...
            <a href="mailto:support@apexcare.com?subject=Re: ${hospitalName} Registration"
              style="display:block;text-align:center;background:linear-gradient(135deg,#FF5A1F,#e64d15);color:#fff;text-decoration:none;padding:13px 24px;border-radius:10px;font-weight:700;font-size:14px;">
              Contact Support →
            </a>
          </div>
...
module.exports = {
  ...
  sendHospitalSuspensionEmail,   // ← new
  sendHospitalRejectionEmail,    // ← new
};